package com.angopapo.datoo.home.popularity;
                ...
                RewardedAdCallback adCallback = new RewardedAdCallback() {
                    ...
                    public void onRewardedAdClosed() {
                        ...
                        if (creditsAdded != 0){
                            ...
                            QuickHelp.showNotification(PopularityActivity.this, creditsAdded + " " + Application.getInstance().getString(R.string.credit_added_to_yo_a), false);
