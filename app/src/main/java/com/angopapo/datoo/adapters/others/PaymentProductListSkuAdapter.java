...
public class PaymentProductListSkuAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PaymentProductListSkuAdapter(List<SkuDetails> paymentProductModelList, ItemViewHolder.OnItemSelectedListener itemSelectedListener) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (viewHolder.getItemViewType() == FOOTER_VIEW){
            ...
            headerViewHolder.mTermsnAndConditions.setOnClickListener(v -> {
